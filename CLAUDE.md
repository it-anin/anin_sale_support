...
|---|---|---|---|
| เห็นข้อมูล | เฉพาะสาขาตัวเอง (`.eq('branch', userBranch)`) | ทุกสาขา (สลับแท็บ) | ทุกสาขา (สลับแท็บ) |
| แก้ไข/เพิ่มแถว | ✓ (เฉพาะแถวตัวเอง) | ✓ | **✕ — ดูอย่างเดียวทั้งหมด** |
| **ลบแถว / ล้างหมด** | **✕ — กันเบิกซ้ำ (ดูด้านล่าง)** | ✓ | ✕ |
| กดปุ่ม Outbound (ส่งขออนุมัติ) | ✓ | — | ✕ |
| กดอนุมัติ / แจ้งของหมด / ลบทิ้งถาวร / Export | — | ✓ | ✕ |

- 🚨 **สาขาลบแถวไม่ได้เลย ทั้งปุ่มถังขยะรายแถวและปุ่ม "ล้างหมด"** (2569-08-18) — เจตนาคือ **กันเบิกซ้ำ**: ถ้าสาขาลบแถวที่คลังจ่ายของไปแล้วได้ แล้วลงรายการใหม่ ของจะถูกเบิกออกสองรอบโดยไม่มีร่องรอย · สาขาที่ลงผิดให้**แก้ค่าในแถวเดิม** (ช่องยังแก้ได้ตราบใดที่ยังไม่อนุมัติ) หรือแจ้งคลังให้ลบให้
  - ⚠️ ปุ่ม "ล้างหมด" ต้องปิดคู่กับปุ่มถังขยะเสมอ — ถ้าปิดแค่ปุ่มเดียว สาขาเลี่ยงไปลบรวดเดียวทั้งสาขาผ่านอีกปุ่มได้ กันไม่ได้จริง
