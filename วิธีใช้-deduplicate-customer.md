...
> **Legacy:** uploader รุ่นปัจจุบันยุบข้อมูลซ้ำและเก็บรายการล่าสุดต่อ ลูกค้า+SKU
> ให้อัตโนมัติแล้ว จึงไม่ต้องใช้ขั้นตอนในเอกสารนี้สำหรับงานอัปโหลดประจำวัน
> ใช้เอกสารนี้เฉพาะกรณีต้องสร้างไฟล์ CSV ที่กรองแล้วแยกต่างหาก
